...
C_SRCS += \
../Core/Src/PTC_UART3.c \
../Core/Src/UART0_RingBuffer_lib.c \
../Core/Src/main.c \
...
OBJS += \
./Core/Src/PTC_UART3.o \
./Core/Src/UART0_RingBuffer_lib.o \
./Core/Src/main.o \
...
C_DEPS += \
./Core/Src/PTC_UART3.d \
./Core/Src/UART0_RingBuffer_lib.d \
./Core/Src/main.d \
...
Core/Src/PTC_UART3.o: ../Core/Src/PTC_UART3.c Core/Src/subdir.mk
	arm-none-eabi-gcc "$<" -mcpu=cortex-m4 -std=gnu11 -g3 -DDEBUG -DUSE_HAL_DRIVER -DSTM32F407xx -c -I../Core/Inc -I../Drivers/STM32F4xx_HAL_Driver/Inc -I../Drivers/STM32F4xx_HAL_Driver/Inc/Legacy -I../Drivers/CMSIS/Device/ST/STM32F4xx/Include -I../Drivers/CMSIS/Include -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"Core/Src/PTC_UART3.d" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@"
Core/Src/UART0_RingBuffer_lib.o: ../Core/Src/UART0_RingBuffer_lib.c Core/Src/subdir.mk
	arm-none-eabi-gcc "$<" -mcpu=cortex-m4 -std=gnu11 -g3 -DDEBUG -DUSE_HAL_DRIVER -DSTM32F407xx -c -I../Core/Inc -I../Drivers/STM32F4xx_HAL_Driver/Inc -I../Drivers/STM32F4xx_HAL_Driver/Inc/Legacy -I../Drivers/CMSIS/Device/ST/STM32F4xx/Include -I../Drivers/CMSIS/Include -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"Core/Src/UART0_RingBuffer_lib.d" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@"
